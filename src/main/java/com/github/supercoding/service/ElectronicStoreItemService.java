...
public class ElectronicStoreItemService {
    ...
    public Integer buyItems(BuyOrder buyOrder) {
        ...
        StoreSales storeSales = itemEntity.getStoreSales()
                .orElseThrow(() -> new NotFoundException("요청하신 StoreId에 해당하는 StoreSale 없습니다."));
    ...
    public Page<Item> findAllWithPagable(Pageable pageable) {
    ...
    public Page<Item> findAllWithPagable(List<String> types, Pageable pageable) {
