...
public class AirlineTicketJdbcTemplateDao implements AirlineTicketRepository{
    ...
    static RowMapper<AirlineTicket> airlineTicketRowMapper = (((rs, rowNums) ->
            new AirlineTicket(
                    rs.getInt("ticket_id"),
    ...
    @Override
    public List<AirlineTicket> findAllAirlineTicketWithPlaceAndTicketType(String likePlace, String ticketType) {
